        ...
        <Box>
            ...
            >
                <Box sx={{ color: "white", marginRight: "100px" }}>
                    ...
                    <Typography sx={{ m: "20px 0px", fontSize: "20px", overflow: "wrap", fontFamily: "inherit" }}>Welcome innovators! Showcase your groundbreaking ideas and let your project shine—submit your hackathon masterpiece today and inspire creativity worldwide </Typography>
