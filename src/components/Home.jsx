        ...
        <Box>
            ...
            >
                <Box sx={{ color: "white", marginRight: "100px" }}>
                    ...
                    <Typography sx={{ m: "20px 0px", fontSize: "20px", overflow: "wrap", fontFamily: "inherit" }}>ur adipisicing elit. Magnam aliquid rerum sunt fuga. Dolor omnis obcaecati excepturi velit libero vitae quia minima, maxime molestiae animi architecto unde nobis rerum </Typography>
